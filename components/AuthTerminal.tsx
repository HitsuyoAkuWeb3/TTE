...
export const AuthTerminal: React.FC = () => {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-4">
            <div className="max-w-md w-full border border-zinc-800 p-8 bg-black relative overflow-hidden shadow-hard">
                ...
                <div className="flex justify-center [&_.cl-rootBox]:w-full [&_.cl-card]:bg-transparent [&_.cl-card]:shadow-none [&_.cl-card]:border-0 [&_.cl-headerTitle]:text-white [&_.cl-headerSubtitle]:text-zinc-500 [&_.cl-formButtonPrimary]:bg-white [&_.cl-formButtonPrimary]:text-black [&_.cl-formFieldInput]:bg-zinc-900/50 [&_.cl-formFieldInput]:border-zinc-700 [&_.cl-formFieldInput]:text-white [&_.cl-footerActionLink]:text-zinc-400 [&_.cl-dividerLine]:bg-zinc-800 [&_.cl-dividerText]:text-zinc-600 [&_.cl-socialButtonsBlockButton]:border-zinc-800 [&_.cl-socialButtonsBlockButton]:text-zinc-400 [&_.cl-socialButtonsBlockButton:hover]:border-white [&_.cl-socialButtonsBlockButton:hover]:text-white">
                    <SignIn
                        appearance={{
                            elements: {
                                rootBox: 'w-full',
