    ...
    return (
        <div className="max-w-lg mx-auto px-4">
            ...
            <form onSubmit={(e) => { e.preventDefault(); onComplete(profile); }} className="space-y-6">
                <div>
                    <div>
                        <label htmlFor="calibration-name" className="block text-[10px] uppercase text-zinc-500 mb-2 font-mono tracking-widest">{v.label_name}</label>
                        <input
                            id="calibration-name"
                            type="text"
                            value={profile.name}
                            onChange={(e) => setProfile(p => ({ ...p, name: e.target.value }))}
                            className="w-full bg-zinc-900/50 border border-zinc-700 text-bone p-3 font-mono focus:outline-none focus:border-white transition-colors"
                ...
                <div>
                    <label htmlFor="calibration-industry" className="block text-[10px] uppercase text-zinc-500 mb-2 font-mono tracking-widest">{v.label_industry}</label>
                    <input
                        id="calibration-industry"
                        type="text"
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full bg-zinc-900/50 border border-zinc-700 text-bone p-3 font-mono focus:outline-none focus:border-white transition-colors h-20 resize-none"
                        placeholder={v.placeholder_goal}
                    />
                </div>
                <div>
                    <span className="block text-[10px] uppercase text-zinc-500 mb-2 font-mono tracking-widest">{v.label_tone}</span>
