...
import { generateAudioDossier, pcmToAudioBuffer, validateMarketWithSearch, refinePilotProtocol } from '../../services/geminiService';
...
export const InstallationPhase: React.FC<{
    ...
    const renderFinalizeActions = () => {
        ...
        return (
            <>
                <Button onClick={onSave} disabled={isSaving} variant="gold" className="w-full md:w-auto">
    ...
    return (
       ...
       `}>
         ...
         `}>
                ...
                <div className="mb-4">
                    <button onClick={onBack} className="text-xs font-mono text-zinc-500 hover:text-bone">&larr; CHANGE TOOL</button>
                </div>
                ...
                {plan && (
                    <>
                        <Button
                            ...
                            variant="secondary"
                            className="border-zinc-700 text-zinc-400 hover:text-bone hover:border-white"
                        >
                            [ COPY PROTOCOL MD ]
                        </Button>
                        <Button
