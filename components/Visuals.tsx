...
export const ArmoryMap: React.FC<ArmoryMapProps> = ({ items }) => {
  ...
  return (
    <div className="w-full h-[400px] bg-zinc-950 border border-zinc-800 relative">
      <div className="absolute top-2 left-1/2 -translate-x-1/2 text-[10px] font-mono text-zinc-500">INSTRUMENT (DISCIPLINE)</div>
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-[10px] font-mono text-zinc-500">TOY (DISCOVERY)</div>
      <div className="absolute left-2 top-1/2 -translate-y-1/2 -rotate-90 text-[10px] font-mono text-zinc-500">TOOL (CONSTRUCTION)</div>
      <div className="absolute right-2 top-1/2 -translate-y-1/2 rotate-90 text-[10px] font-mono text-zinc-500">WEAPON (DISRUPTION)</div>
              ...
              if (active && payload && payload.length) {
                ...
                return (
                  <div className="bg-black border border-white p-2 font-mono text-xs">
                    <p className="font-bold">{data.verb}</p>
